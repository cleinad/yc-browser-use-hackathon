      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-5xl flex-col">
        ...
        <section className="mx-auto my-auto w-full max-w-2xl rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)] sm:p-10">
          ...
          <div className="mt-8">
            <Link
              href="/chat"
              className="inline-flex items-center rounded-lg bg-[var(--accent-primary)] px-5 py-2.5 text-sm font-medium text-[var(--bg-base)] transition hover:bg-[var(--accent-primary-hover)]"
            >
              Open Chat Workspace
            </Link>
          </div>
